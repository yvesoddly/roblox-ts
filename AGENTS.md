...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `packages/roblox-ts/src/CLI/`                                          | Argument parsing and terminal behavior. `cli.ts` loads commands; `commands/build.ts` drives normal and watch builds. Shared compilation behavior belongs in Project.                                                               |
